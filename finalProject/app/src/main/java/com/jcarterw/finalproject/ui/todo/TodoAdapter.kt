...
class TodoAdapter(private val mTodo: List<TodoMember>) : RecyclerView.Adapter<TodoAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: TodoAdapter.ViewHolder, position: Int) {
        val faculty: TodoMember = mTodo[position]
