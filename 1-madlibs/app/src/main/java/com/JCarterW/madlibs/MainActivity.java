...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        occupationView.setText("Enter a Occupation");
        ...
        placeView.setText("Enter a place");
        ...
        thingView.setText("Enter a thing");
        ...
        name2View.setText("Enter a name");
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                messageView.setText(name + " is so " + adjective +". He has a job as a " + occupation + ", but I'm not sure how he got that job. He always carries around a " + thing + " and is always talking to " + name2 + ". To top it all off, he spends so much time in " + place + ". What an interesting guy.");
            }
        });
